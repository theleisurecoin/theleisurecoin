    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a valid TheLeisureCoin address"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a valid TheLeisureCoin address"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter TheLeisureCoin signature"));
#endif
